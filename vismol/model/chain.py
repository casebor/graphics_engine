...
class Chain:
    ...
    def __init__ (self, name=None, residues=None, label=None, vismol_object = None):
        """ Class initialiser """
        #self.residues = {}
        self.residues = []
    ...
    def generate_backbone_indexes (self):
        ...
        for pair in self.backbone_pair_indexes_show:
            self.vismol_object.backbone_full_indexes.append(pair[0])
            self.vismol_object.backbone_full_indexes.append(pair[1])
