...
class VismolObject:
    ...
    vismol_session  = Vismol Session - Necessary to build the "atomtree_structure"
                 vismol_session contains the atom_id_counter (self.vismol_session.atom_id_counter)
    ...
    def __init__(self, active=False, name="UNK", atoms=None, vismol_session=None,
        ...
        self.index          = 0             # import to find vboject in self.vismol_session.vismol_objects_dic
        ...
        if auto_find_bonded_and_nonbonded:
            ...
            self._find_bonded_and_nonbonded_atoms(selection=self.atoms, frame=0,
                    gridsize=self.vismol_session.vConfig.gl_parameters["gridsize"], 
                    maxbond=self.vismol_session.vConfig.gl_parameters["maxbond" ],
                    tolerance=self.vismol_session.vConfig.gl_parameters["bond_tolerance"])
    ...
    def create_new_representation(self, rtype="lines", indexes=None):
        ...
        if rtype == "lines":
            self.representations["lines"] = LinesRepresentation(name=rtype,
                                              ...
                                              glCore=self.vismol_session.glwidget.vm_widget)
            ...
            print("Representation {} not implemented".format(rtype))
